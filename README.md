<div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; color: #282d33;">
  <div style="font-weight: 700; font-size: 16px; margin-bottom: 20px; line-height: 1.6;">
    Hi there! I'm a college student learning programming <br>
    I’m studying C#, Game development
  </div>
  
  <div style="margin-bottom: 30px;">
    <h2 style="font-size: 16px; margin-bottom: 15px;">🛠️ Skills</h2>
